...
const ViewTaskDialog = ({ taskData }) => {
  ...
  const dialogueStyling = ` ${
    deleteTaskFromView ? "border-none bg-blue-50 bg-opacity-90" : "bg-gray-50"
  ...
  const overlayStyling = `fixed inset-0 border z-30 flex items-center`;
          ...
          <div className="flex flex-col gap-8">
            <div className="gap-2">
              <div className="flex flex-row w-full items-center">
                <RegularParagraph styling="w-full pb-4 text-[#0B1869] text-xl font-bold">
                  Your Task Status
                </RegularParagraph>
                ...
                <div className="w-full flex flex-wrap justify-end gap-2 mb-5">
                  <button
                    title="delete"
                    className={`hover:bg-[#0B1869] ${buttonStyling}`}
