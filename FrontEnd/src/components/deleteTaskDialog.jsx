...
const DeleteTaskDialog = ({ tasksToDelete }) => {
  ...
  const dialogueStyling = ` ${scrollBarStyling} bg-gray-50 z-50 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 rounded-xl border border-blue-300 shadow-lg max-w-md w-full flex flex-wrap justify-center items-center min-h-[200px] max-h-[400px] gap-1`;
  const overlayStyling = `fixed inset-0 border z-50 flex items-center`;
