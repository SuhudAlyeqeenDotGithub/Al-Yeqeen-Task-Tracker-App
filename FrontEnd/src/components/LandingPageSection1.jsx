...
const LandingPageSection1 = () => {
  const linkClass =
    "text-[#02132D] text-md font-semibold hover:bg-[#02132D] p-2 rounded-md hover:text-white";
  ...
  const blueButtonStyling =
    "w-[200px] h-[50px] bg-[#02132D] hover:text-lg shadow-md text-white font-semibold px-4 border border-[#02132D] rounded-md";
  return (
    <div className="bg-gradient-to-r from-blue-300 to-[#EFF1FD]">
      {/* build the header to consist of the nav and logo */}
      <header className="flex flex-wrap sticky top-0 py-8 items-center px-32 gap-y-4 justify-center md:justify-start bg-gradient-to-r from-blue-300 to-[#EFF1FD]">
      ...
      <div className="flex flex-col p-20 gap-y-32">
        {/* first hero div */}
        <div className="flex justify-between gap-x-10">
          <div className="font-bold text-[40px] w-[50%]">
            A Comprehensive Solution to Enhance Your Task Management Efficiency.
          </div>
          <div className="h-[150px] flex items-center text-center font-semibold italic whitespace-nowrap border-x-4 hover:border-x-6 rounded-lg bg-gradient-to-l from-green-700 to-blue-900 shadow-md text-white cursor-pointer border-[#060242] px-4 lg:mr-32 mr-22 ">
            Stay Organized. Stay Productive. <br />
            The Smartest Way to Track & Manage Your Tasks. <br /> Simplify Your
            Workflow with Al-Yeqeen Task Tracker.
          </div>
        </div>
        ...
        <div className="flex justify-center w-full items-center">
          ...
          <div className="flex flex-col gap-y-20 items-center justify-center w-full">
            <div className="flex items-center justify-center font-semibold whitespace-nowrap border-y-2 border-[#060242] py-4 mr-52 hover:text-xl h-[60px] w-[500px]">
