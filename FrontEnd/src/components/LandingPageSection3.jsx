...
const LandingPageSection3 = () => {
  ...
  const transparentButtonStyle = "border-2 border-[#02132D] rounded-md p-4 font-semibold transform hover:scale-110";
      ...
      <div className="flex items-center justify-between">
        <div className="flex gap-x-2 justify-center w-full">
          <button
            ...
            type="button"
            className={`${switchMediaBtnStyling} ${mediaType === "Video" ? "border-2 border-[#02132D] scale-90" : "scale-105"}`}
            onClick={() => {
          ...
          <button
            ...
            type="button"
            className={`${switchMediaBtnStyling} ${mediaType === "Image" ? "border-2 border-[#02132D] scale-90" : "scale-105"}`}
            onClick={() => {
